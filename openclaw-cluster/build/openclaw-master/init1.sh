  ...
  "plugins": { 
    ...
    "installs": {
        "openclaw-mem0": {
            ...
            "installPath": "/home/node/.openclaw/extensions/openclaw-mem0",
            "version": "0.1.2",
            "resolvedName": "@mem0/openclaw-mem0",
            "resolvedVersion": "0.1.2",
            "resolvedSpec": "@mem0/openclaw-mem0@0.1.2",
            "integrity": "sha512-Q+lwwKUqltMoO0occDdxnUK1xnA76qhT9oNhqpNzYKHEfB7uY4KA484mDSNPZ7KwJudS88bantKOprjhpU+BcA==",
            "shasum": "41601f54f1ccfa9874b1e47066e9db5f6d7923ea",
            "resolvedAt": "2026-03-07T14:20:01.176Z",
            "installedAt": "2026-03-07T14:20:18.528Z"
        }
    } 
  }
}
...
def sync():
    ...
    try:
        ...
        with open('/home/node/.openclaw/openclaw.json', 'r', encoding='utf-8') as file:
            for line in file:
                print(line, end='')
